...
import org.patrickvillatoro.bean.Login;
...
public class LoginController implements Initializable {
    ...
    public ObservableList<Usuario> getUsuario(){
        ...
        try{
            PreparedStatement procedimiento = Conexion.getInstance().getConexion().prepareCall("{call sp_ListaUsuario()}");
    ...
    private void login(){
        ...
        while(x<getUsuario().size()){
            ...
            if(user.equals(lo.getUsuarioMaster()) && pass.equals(lo.getPasswordLogin())){
                JOptionPane.showMessageDialog(null,"Bienvenido!! " +getUsuario().get(x).getNombreUsuario()
