...
public class Paciente {
   ...
   private Date fechaPrimeraVisita;
    ...
    public String toString() {
        return "Paciente{" + "codigoPaciente=" + codigoPaciente + ", nombresPaciente=" + nombresPaciente + ", apellidosPaciente=" + apellidosPaciente + ", sexo=" + sexo + ", fechaNacimiento=" + fechaNacimiento + ", direccionPaciente=" + direccionPaciente + ", telefonoPersonal=" + telefonoPersonal + ", fechaPrimeraVisita=" + fechaPrimeraVisita + '}';
    }
